...
### 8. hugging-apps/fara-computer-use-agent
- Score: 6.5/10
- Source: hf_space
...
### 9. ResidencyRL: Reinforcement Learning in Simulated Clinical Environments
- Score: 6.3/10
- Source: arxiv
...
### 11. Analyzing the Interaction of Optimal Strategies in Mean-Payoff Bidding Games
- Score: 6.0/10
- Source: arxiv
...
### 12. SkillProx: Self-Evolving Agent Skills via Proximal Textual Gradient Descent
- Score: 5.9/10
- Source: arxiv
