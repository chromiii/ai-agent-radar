...
### 2. From Code Review to Code Critique: Intent, Drift, and Spotlight for AI-Generated Diffs at Scale
- Score: 10.0/10
- Source: arxiv
...
### 3. Self-Play Meets Skill Evolution: Self-Evolving Search Agents that Pose, Solve, and Remember
- Score: 10.0/10
- Source: arxiv
...
### 8. Transcript-Managed Transformers: Monotone Multi-Agent Collapse and Universality with Two Pop-Enabled Transcripts
- Score: 5.9/10
- Source: arxiv
...
### 9. N_0-VTLA: Scaling Vision-Tactile-Language-Action Model with Latent Tactile Tokens
- Score: 5.7/10
- Source: hf_daily_papers
...
### 11. HAM-VLN: Harnessing Hierarchical Agentic Memory for Zero-Shot Vision-and-Language Navigation
- Score: 5.6/10
- Source: arxiv
...
### 12. AgentHPOBench: A Benchmark For Evaluating LLM Agents as Sequential Hyperparameter Optimizers
- Score: 5.2/10
- Source: arxiv
...
- Why: keyword: agent, keyword: agents, keyword: llm agent, high-value: benchmark, high-value: code, weekly-downrank: llm agents
...
- Why: keyword: agent, high-value: dataset, high-value: code, high-value: tool, weekly-downrank: reflection, new arXiv paper
...
### 19. Enhancing Rubric-based RL via Self-Distillation
- Score: 3.1/10
- Source: hf_daily_papers
...
- Why: high-value: planning, weekly-downrank: planning, appeared on HF Daily Papers
